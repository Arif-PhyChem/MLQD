...
__QDmodelIn__='QDmodelIn (str): Pass the name of the trained QD model and MLQD will use it to predict dynamics. In the case of cons_trace = True, two models can be provided seperated by comma'
...
__cons_trace__='cons_trace (str): Dafualt option is False and in the case of True, MLQD will implement the constraint of trace conservation while dynamics propagation. At this moment, it is only available for recursive dynamics with NN (RCDYN)'
...
def help():
    ...
    i+=1; print(str(i) + ']===>',__cons_trace__)
    print('\n------------------------------------------------------------------')
